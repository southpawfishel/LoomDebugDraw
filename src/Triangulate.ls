...
translated to loomscript by Dave Fishel
...
package DebugDraw
{
    ...
    public class Triangulate
    {
        ...
        public static function process(contour:Vector.<Point>):Vector.<Point>
        {
            ...
            var verts:Vector.<Number> = new Vector.<Number>(contour.length * 2);
            ...
            for(v = nv - 1; nv > 2; )
            {
                ...
                if (snip(contour,u,v,w,nv,verts))
                {
                    ...
                    // output Triangle
                    result.pushSingle(contour[a]);
                    result.pushSingle(contour[b]);
                    result.pushSingle(contour[c]);
        ...
        public static function area(contour:Vector.<Point>):Number
        {
            var n:int = contour.length;
            var a:Number    = 0.0;
        ...
        public static function insideTriangle(ax:Number, ay:Number,
                                       bx:Number, by:Number,
                                       cx:Number, cy:Number,
        ...
        private static function snip(contour:Vector.<Point>, u:int, v:int, w:int, n:int, verts:Vector.<Number>):Boolean{
            var p:int;
            var ax:Number, ay:Number, bx:Number, by:Number;
